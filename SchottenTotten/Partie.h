...
{
protected:
    std::vector<std::shared_ptr<Carte>> cartes; // Pioche polymorphe
...
public:
    ...
    bool EstBrelan(const std::vector<std::shared_ptr<Carte>>& trioDeCarte);
    int getRangCombinaison(const std::vector<std::shared_ptr<Carte>>& trio);
    virtual bool EstGagnant(const std::vector<std::shared_ptr<Carte>>& trioDeCarteJ1, const std::vector<std::shared_ptr<Carte>>& trioDeCartej2, Joueur* J1, Joueur* J2, Joueur* First);
    ...
    bool FinDePartie();
    virtual bool EstRevendiquable(const std::vector<std::shared_ptr<Carte>>& trioDeCarteJ1, const std::vector<std::shared_ptr<Carte>>& Cartesj2, Joueur* J1, Joueur* J2);
